                            ...
                            <div class="card-body ">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-2">
                                            ...
                                            <form action="buscarIn.php" method="POST">
                                                <input type="submit" value="Reporte General" class="btn btn-info btn-sm">
                                            </form>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <form action="impri.php" method="POST" target="_blank">
                                            <input type="hidden" name="variable1" value="<?php echo $busqueda ?>" />

                                            <label>Obtener reporte actual</label>
                                            <select name="tipo_reporteC" required>
                                                <option selected disabled value="">-- Selecione un formato--</option>
                                                <option>EXCEL</option>
                                                <option>PDF</option>
                                            </select>

                                            <input type="submit" name="reporteE" value="Exportar" class="btn btn-secondary btn-sm">
                                        </form>
