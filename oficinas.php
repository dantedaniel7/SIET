        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid px-4">
                    <h3>Administración de Oficinas</h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                          <div class="row align-items-center">
                              <div class="col-10">
                                Agregue oficinas, actualice sus datos o eliminelos del sistema.
                              </div>
                              ...
                              <button type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#users">
                                 <div class="sb-nav-link-icon"><i class="fas fa-map-marked-alt"></i></div> Añadir Oficina
                              </button>
                              </div>
                          </div>
                        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Añadir Oficina</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <select name="cod_depar">
                                                <?php
                                                    while($datos = mysqli_fetch_array($querydepar))
                                                    {
	                                                ?>
	                                                    <option value="<?php echo $datos["cod_depar"] ?>">
                                                        <?php echo $datos["nombre_depar"];?></option>
	                                                    <?php
                                                    }
                                                ?>
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="cod_ofi" type="text" class="form-control" id="validationCustom02" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="oficina" type="text" class="form-control" id="validationCustom02" required>
                                            <div class="invalid-feedback">
                                                Por favor ingrese una oficina válida
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                        <button type="submit" name="insertOfic" class="btn btn-primary">Guardar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <form action="update.php" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="nombre_ofiU" type="text" class="form-control" id="nombre_ofiU" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                            <button type="submit" name="updateoficina" class="btn btn-primary">Guardar</button>
                        </div>
        ...
        <div class="modal fade" id="deletemodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" name="deleteidOfi" class="btn btn-primary">Eliminar</button>
                    </div>
                    </form>
                </div>
            </div>
