        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid px-4">
                    <h3>Administración de Direcciones</h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                          <div class="row align-items-center">
                              <div class="col-10">
                                Agregue direcciones, actualice sus datos o eliminelos del sistema.
                              </div>
                              ...
                              <button type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#users">
                                 <div class="sb-nav-link-icon"><i class="fas fa-map-marked-alt"></i></div> Añadir Dirección
                              </button>
                              </div>
                          </div>
                        </div>
                                ...
                                <form action="register.php" method="POST" class="needs-validation" novalidate>
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <input name="cod_direc" type="text" class="form-control" id="validationCustom02" required>
                                            <div class="invalid-feedback">
                                                Por favor ingrese una ID válido
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" name="insertDirec" class="btn btn-primary">Guardar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<!-- Agregar Departamento -->
        ...
        <div class="modal fade" id="editmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Actualizar datos de dirección </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="update.php" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="nombre_direcU" type="text" class="form-control" id="nombre_direcU" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                            <button type="submit" name="updatedireccion" class="btn btn-primary">Guardar</button>
                        </div>
        ...
        <div class="modal fade" id="deletemodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       Se eliminara la dirección seleccionada, desea continuar? 
                       <input type="hidden" name="delete_id" id="delete_id">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" name="deleteidD" class="btn btn-primary">Eliminar</button>
                    </div>
                    </form>
                </div>
            </div>
